...
|---------|------------|-------------|
| `+` | public | Champ accessible publiquement (`public` en Java) |
| `#` | protégé | Champ accessible aux classes dérivées (`protected` en Java) |
| `~` | package | Champ accessible aux classes du même package (aucun modificateur en Java) |
| `-` | privé | Champ accessible uniquement dans la classe (`private` en Java) |
...
classDiagram
    ...
    Departement o-- "0..*" Enseignant : agrégation
    class Cours {
        +code : String
        +titre : String
    }
